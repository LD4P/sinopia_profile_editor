...
angular.module('locApp.modules.profile.services')
    .factory('ProfileHandler', function() {
        ...
        var profAttributes = ["id","title","description","date","author","remark","adherence","resourceTemplates", "source"];
        var resAttributes = ["id","resourceURI","resourceURL","resourceLabel","propertyTemplates","author","remark"];
